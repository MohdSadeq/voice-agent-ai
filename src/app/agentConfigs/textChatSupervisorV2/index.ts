/**
 * Text Chat Supervisor V2 - Main export file
 * Configures all agents and their handoff relationships for text chat
 * Based on customerServiceV2 architecture with text-optimized agents
 */
...
export const textChatSupervisorV2Scenario = [
    supervisorAgent,
    accountAgent,
    plansAgent,
    planUpgradeAgent,
...
export const textChatSupervisorV2CompanyName = 'redONE Mobile Service';
